  ...
  <div class="">
    ...
    <div className="bg-cyan-600 rounded-t-2xl ">
      ...
      <form class="flex flex-col items-center justify-center ">
        <div
          id="date"
          class="flex flex-row overflow-x-scroll w-screen  "
        >
          <div class="pl-5"
          ...
          <BookingTime class="w-screen grid grid-cols-2 grid-rows-2 p-5 gap-5" @onTimeUpdate="BookingTimeData" />
        
        
        <div class="mt-24 pb-20" >
       <button
        class="p-4 w-64 rounded-md text-white bg-green-700 hover:bg-green-800 font-medium rounded-md text-base" @click.prevent="handleConfirm()">Boka tid</button>
        </div>
      </form>
