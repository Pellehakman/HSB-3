...
<template>
  ...
  <form class="flex flex-col mt-14 h-screen">
    <input
      required
    ...
    <p class="flex h-4 text-xs justify-end mt-3 mb-3 font-medium text-red-600">
      {{ emlErrors }}
    </p>
    ...
    <div class="mt-44">
      ...
      <div class="flex justify-center place-self-center">
        <RouterLink class="text-xs mt-4" to="/register"
